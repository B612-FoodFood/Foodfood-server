...
class MemberServiceTest {
    ...
    public void test3() throws Exception {
        ...
        Food food1 = new Food("food1", new Nutrition(1, 1, 1, 11, 1, 11D, 1D, 1D, 1D, 1D), Category.견과류및종실류);
        Food food2 = new Food("food2", new Nutrition(1, 1, 1, 11, 1, 11D, 1D, 1D, 1D, 1D), Category.견과류및종실류);
