...
public class MealService {
    ...
    public Long save(Meal meal) throws NoDataExistException {
    ...
    public Meal findMealById(Long mealId) throws NoDataExistException {
    ...
    public Meal findMealByDate(LocalDate date) throws NoDataExistException {
