...
public class BodyCompositionService {
    ...
    public BodyComposition findBodyCompositionById(Long bodyCompId) throws NoDataExistException {
    ...
    public BodyComposition findBodyCompositionByDate(LocalDate date) throws NoDataExistException {
